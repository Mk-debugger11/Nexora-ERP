...
const ManagePurchaseOrder = ({onProductSelected}) => {
    ...
    const confirmDelete = async () => {
        ...
        const res = await callApi({ url: `orders/purchaseOrder/delete/${poToDelete.id}/`, method: 'DELETE' });
        if (res) {
    ...
    return (
        <Box component={"div"} sx={{width:'100%'}}>
            ...
            <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                ...
                <Button variant="contained" onClick={()=>navigate('/create/po')} startIcon={<Add />}>Add Purchase Order</Button>
            </Box>}
            ...
            <DataGrid
                ...
                <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            Are you sure you want to delete Purchase Order #{poToDelete?.po_code}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
