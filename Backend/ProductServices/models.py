...
class Products(models.Model):
    ...
    supplier_id=models.ForeignKey(Users,on_delete=models.CASCADE,blank=True,null=True,related_name='supplier_id_products')
    stock_alert_quantity=models.IntegerField(default=10)
